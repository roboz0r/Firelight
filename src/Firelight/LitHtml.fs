...
[<Erase>]
type Renderable =
    | RenderableString of string
    | RenderableFloat of float
    | RenderableBoolean of bool
    | RenderableBigInt of bigint
    | RenderableNull
    | RenderableUndefined
    | RenderableHTMLElement of HTMLElement
    | RenderableResizeArray of ResizeArray<Renderable>
    | RenderableArray of Renderable[]
    | RenderableSeq of seq<Renderable>
    | RenderableHTMLTemplate of HTMLTemplateResult
    | RenderableNothing of nothing
